...
import com.xuetangx.streaming.StreamingFormater
 ...
 */
class PlatformLogFormater extends StreamingFormater {

  override def format(stream: DStream[String]): DStream[String] = {
