...
//        val defaultLogProps = "org/apache/spark/log4j-defaults.properties"
        val defaultLogProps = "com/xuetangx/streaming/log4j-defaults.properties"
        Option(Utils.getClassLoader.getResource(defaultLogProps)) match {
          case Some(url) =>
            PropertyConfigurator.configure(url)
//            System.err.println(s"Using Spark's default log4j profile: $defaultLogProps")
            System.err.println(s"Using App's default log4j profile: $defaultLogProps")
          case None =>
            System.err.println(s"App was unable to load $defaultLogProps")
        }
      }
    }
